...
Config.PreventExitWhileBuckled = false -- F / exit always works, even while buckled
Config.DisablePassengerSeatbelts = false
Config.MinSpeedMphEjectionSeatbeltOff = 100.0 -- was 20 (too low = random white-flash ejects)
Config.MinSpeedMphEjectionSeatbeltOn = 9999.0 -- buckled = do not eject
...
Config.DevDeleteAllUserSettingsOnStart = false -- true = wipe HUD layout/settings KVP on every login (resets player edits)
Config.Debug = false