    ...
    while true do
        ...
        if currentZone then
            ...
            if IsControlJustReleased(0, 38) then
                if not exports['es_extended']:Limit('limit', {name = 'illenium-appearance-interact', seconds = 5}) then
                ...
                exports['es_extended']:Limit('start', {ms = 5000, name = 'illenium-appearance-interact'})
            end
        end
        Wait(sleep)
    end
