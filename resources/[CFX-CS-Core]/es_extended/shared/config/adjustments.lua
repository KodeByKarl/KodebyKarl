...
Config.DiscordActivity = {
    ...
    assetName = "big", --image name for the "large" icon.
    assetText = "CFX-CS-V2", -- Text to display on the asset
    buttons = {
        { label = "Connect to Server", url = "fivem://connect/:30120" },
        { label = "Discord", url = "https://discord.gg/cscripts" },
    },
    -- presence = "{player_name} [{player_id}] | {server_players}/{server_maxplayers}",
    presence = "{player_name} | {server_players}/{server_maxplayers}",
