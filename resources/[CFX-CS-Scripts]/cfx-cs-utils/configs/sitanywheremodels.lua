-- Seat model hashes + offsets (vanilla GTA chairs/benches, 200+ models).
-- Extra map props can be added at the bottom of this table.
...
return {
	...
	-- Add extra map/chair models below this line.
}